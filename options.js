...
function setupOptions() {
	for(let i = 0; i < names.names.length; i++) {
		...
		let html1 = "<div id=" + title +" class=shortcutsContainer><div class=title><p class=pTitle>" + title + "</p></div><div class=key><input type=\"text\" maxlength=\"1\" autocomplete=\"off\" value = " + key + "></div></div>";document.getElementById("root_list").innerHTML += html1;
	}
